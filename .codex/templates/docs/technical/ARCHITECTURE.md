...
For design tokens, component specs, and UX flows see DESIGN_SYSTEM.md (@designer).
-->
...
The canonical **design system** (tokens, typography, spacing, component inventory, interaction patterns) and **UX flow summaries** live in [`DESIGN_SYSTEM.md`](./DESIGN_SYSTEM.md). That file is owned by @designer. Other agents: read-only — do not edit it unless you are @designer.
