---
description: Orchestrate a multi-agent task — analyzes dependencies, builds a wave execution plan, coordinates specialists, creates a feature branch, and runs specialist agents in parallel and sequential waves. Usage: prompt:orchestrate <task description>
...
1. Read `AGENTS.md` — understand the project context, tech stack, and the full list of available agents and their domains.
...
Apply this domain routing (mirrors the delegation table in AGENTS.md):
...
Follow your standard working protocol. Adhere to all AGENTS.md conventions. Commit your work with Conventional Commits format when done.
```
...
- Only invoke agents listed in AGENTS.md. Do not invent new agents.
