---
description: Project health overview — renders a structured status card from TODO.md, recent git history, open PRs, and PRD open questions. Usage: prompt:status
---
